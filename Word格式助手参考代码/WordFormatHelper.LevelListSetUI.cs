...
// WordFormatHelper.LevelListSetUI
using System;
...
public class LevelListSetUI : UserControl
{
	...
	{
		if (Cmb_LstTLevels.SelectedIndex != -1)
		{
			new LevelStyleSettingUI(Cmb_LstTLevels.SelectedIndex + 1).ShowDialog(base.Parent as Form);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		this.Btn_SetStyles.Enabled = false;
		this.Btn_SetStyles.Location = new System.Drawing.Point(240, 364);
		this.Btn_SetStyles.Name = "Btn_SetStyles";
		this.Btn_SetStyles.Size = new System.Drawing.Size(120, 30);
		this.Btn_SetStyles.TabIndex = 78;
		this.Btn_SetStyles.Text = "设置每级样式";
