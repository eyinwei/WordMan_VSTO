...
public class PageSetUI : UserControl
{
	...
	public PageSetUI()
	{
		...
		CmbHeaderFooterFontName.Items.AddRange(((IEnumerable<object>)families.Select((FontFamily fontFamily) => fontFamily.Name)).ToArray());
	...
	private void AddHistoryInputItems([Optional] List<string> newItems)
	{
		...
		else
		{
			...
			foreach (string newItem6 in list)
			{
				array[num] = newItem6;
				num++;
			}
			...
			foreach (string newItem6 in list2)
			{
				array[num] = newItem6;
				num++;
			}
			...
			foreach (string newItem6 in list3)
			{
				array[num] = newItem6;
				num++;
			}
			...
			foreach (string newItem6 in list4)
			{
				array[num] = newItem6;
				num++;
			}
			...
			foreach (string newItem6 in list5)
			{
				array[num] = newItem6;
				num++;
			}
			...
			foreach (string newItem6 in list6)
			{
				array[num] = newItem6;
				num++;
			}
